...
export class TransactionController {
  ...
  verifyAccount(@Body() { account_number, account_bank }: any) {
    return this.transactionService.verifyAccountNumber({
      account_number,
      account_bank,
    });
  }
  ...
  exchangeCurrency(
    ...
    return this.transactionService.exchangeCurrency({
      id,
      newAmount,
      newCurrency,
      exchangeCurrency,
  ...
  smeData(
    ...
    id: string,
    @Body()
    { network_id, phone, plan_id, amount }: SmeDataDTO,
  ) {
    return this.transactionService.smeData({
      network_id,
      phone,
      plan_id,
      id,
